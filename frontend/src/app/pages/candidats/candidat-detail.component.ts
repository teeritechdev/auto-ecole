    ...
    <div class="candidat-detail-page" *ngIf="candidat">
      ...
      <div class="header-action-bar">
        ...
        <div class="action-buttons">
          ...
          <button class="btn btn-primary" *ngIf="canAddExam" (click)="openExamenModal()">
      ...
      <div *ngIf="candidat.procheExpiration" class="alert alert-warning">
      ...
      <div class="card tab-content" *ngIf="activeTab === 'dossier'">
        <div class="info-grid">
      ...
      <div class="card tab-content" *ngIf="canSeeFinancialData && activeTab === 'paiements'">
        ...
        <div class="table-responsive" *ngIf="paiements.length > 0">
          <table class="custom-table">
            ...
            <tbody>
              <tr *ngFor="let p of paiements">
                ...
                <td class="text-right">
                  <button class="btn btn-outline btn-sm" *ngIf="p.recuId" (click)="imprimerRecu(p.recuId)" title="Imprimer reçu PDF">
                    🖨️ Reçu PDF
                  </button>
                </td>
              </tr>
      ...
      <div class="card tab-content" *ngIf="activeTab === 'examens'">
        <div class="card-header">
          <div class="card-title">Épreuves Pédagogiques (Jusqu'à 5 passages autorisés par épreuve)</div>
          <button class="btn btn-primary btn-sm" *ngIf="canAddExam" (click)="openExamenModal()">
            ➕ Nouveau Passage
          </button>
        </div>
        ...
        <div class="exam-grid">
          ...
          <div class="exam-card">
            ...
            <div class="passage-list">
              <div *ngIf="!bilan?.passagesCode || bilan!.passagesCode.length === 0" class="no-passage">
                Aucun passage enregistré
              </div>
              <div *ngFor="let pass of bilan?.passagesCode" class="passage-item">
                <div>
                  <strong>Passage n°{{ pass.numeroPassage }}/5</strong> — {{ pass.datePassage | date:'dd/MM/yyyy' }}
                  <div class="obs" *ngIf="pass.observations">{{ pass.observations }}</div>
                </div>
          ...
          <div class="exam-card">
            ...
            <div class="passage-list">
              <div *ngIf="!bilan?.passagesCreneau || bilan!.passagesCreneau.length === 0" class="no-passage">
                Aucun passage enregistré
              </div>
              <div *ngFor="let pass of bilan?.passagesCreneau" class="passage-item">
                <div>
                  <strong>Passage n°{{ pass.numeroPassage }}/5</strong> — {{ pass.datePassage | date:'dd/MM/yyyy' }}
                  <div class="obs" *ngIf="pass.observations">{{ pass.observations }}</div>
                </div>
          ...
          <div class="exam-card">
            ...
            <div class="passage-list">
              <div *ngIf="!bilan?.passagesCirculation || bilan!.passagesCirculation.length === 0" class="no-passage">
                Aucun passage enregistré
              </div>
              <div *ngFor="let pass of bilan?.passagesCirculation" class="passage-item">
                <div>
                  <strong>Passage n°{{ pass.numeroPassage }}/5</strong> — {{ pass.datePassage | date:'dd/MM/yyyy' }}
                  <div class="obs" *ngIf="pass.observations">{{ pass.observations }}</div>
                </div>
      ...
      <!-- MODAL VERSEMENT -->
      <div class="modal-backdrop" *ngIf="showPaiementModal">
        <div class="modal-content">
          ...
          <form (ngSubmit)="savePaiement()">
            <div class="modal-body">
              <div *ngIf="paiementError" class="alert alert-danger">⚠️ {{ paiementError }}</div>
      ...
      <!-- MODAL EXAMEN -->
      <div class="modal-backdrop" *ngIf="showExamenModal">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <form (ngSubmit)="saveExamen()">
            <div class="modal-body">
              <div *ngIf="examenError" class="alert alert-danger">⚠️ {{ examenError }}</div>
